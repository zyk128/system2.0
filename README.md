...
覆盖**两套真实数据、两个独立模型**：美式快餐（完整 Nutri-Score）+ 中国菜（八大菜系，去糖简化 Nutri-Score）。提供控制台演示和**网页版交互界面*[*C:\2026ai\ai-summer-camp-2026\student-work\另存无\数据集](https://n6395767-lgtm.github.io/final/)。
